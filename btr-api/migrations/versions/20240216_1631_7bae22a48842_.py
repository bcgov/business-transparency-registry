...
def upgrade():
    ...
    op.execute("delete from submission where id not in (select id from (select business_identifier, max(id) as id from submission group by business_identifier) as foo)")
